...
pub const PLAYER_COMMON_SKILLS_TYPE_HASH: felt252 = selector!(
    "PlayerCommonSkillsParam(player:felt, salt_nonce:felt, is_new_match:bool, is_skills:bool)",
);


pub const PLAYER_COMMON_FOULS_TYPE_HASH: felt252 = selector!(
    "PlayerCommonFoulsParam(player:felt, salt_nonce:felt, is_new_match:bool, is_fouls:bool)",
);
...
pub fn DEFAULT_DOMAIN() -> StarknetDomain {
    StarknetDomain {
        name: 'play5', version: STARKNET_DOMAIN_VERSION, chain_id: get_tx_info().unbox().chain_id,
    }
}
